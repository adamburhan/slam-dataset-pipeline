...
class Pipeline:
    ...
    def run_sequence(self, sequence_id):
        ...
        try:
            ...
            print(f"Pipeline processing failed for {sequence_id}: {e}")
            self.save_metrics_json_failed(sequence_id, sequence.dataset_name, output_dir, start_time, str(e))
            return None
    ...
    def save_metrics_json_failed(self, sequence_id, dataset_name, output_dir: Path, start_time: float, error_msg: str = "Unknown"):
